...
const ThemeChanger = (): JSX.Element => {
  ...
  return (
    <div className='flex items-center gap-2 md:gap-4 p-2 sm:p-4 font-semibold'>
      ...
      {/* Theme toggler */}
      <input type="checkbox" className="toggle toggle-sm md:toggle-md bg-neutral-content" ref={themeToggleRef} onChange={handleThemeToggle} checked={theme === LIGHT_THEME} />
